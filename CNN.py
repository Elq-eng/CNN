...
model = Sequential()
model.add(Conv2D(input_shape=(28, 28, 1), filters=64, strides=(2, 2), padding='same', activation='relu', kernel_size=(2, 2)))
...
checkpointer = ModelCheckpoint(filepath = CKPATH,verbose = 1, save_best_only = True)
